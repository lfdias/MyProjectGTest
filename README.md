...
Install the build-essential package (includes g++):
```
...
# Step 1: Verify that GIT is installed. 
In the Linux shell, run: 
```
git --version
```
...
# Step 5 - Clone the tutorial code
In the Linux shell, run: 
```
...
# Step 6 - Install project pre requirements
In the Linux shell, run: 
```
cd ~/gtests_master
